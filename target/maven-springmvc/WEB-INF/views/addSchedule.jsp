...
<div class="warp">
    ...
    <div class="mainbody">
        ...
        <div class="col-md-10" id="addPlay">
            <form class="form-horizontal" role="form" action="insertschedule" method="post"  onsubmit="return checkAll()">
                ...
                <div class="form-group" id="input-snum">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="schedule-snum" name="studioid"
                               placeholder="输入影厅编号" onBlur="check('input-snum','schedule-snum')" autofocus>
                    </div>
                </div>
                <div class="form-group" id="input-fnum">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="schedule-fnum" name="filmid"
                               placeholder="输入影片编号" onBlur="check('input-fnum','schedule-fnum')" autofocus>
                    </div>
                </div>
                <div class="form-group" id="input-time">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="schedule-time" name="schetime"
                               placeholder="输入演出时间" onBlur="check('input-time','schedule-time')">
                    </div>
                </div>
                <div class="form-group" id="input-price">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="schedule-price" name="scheprice"
                               placeholder="输入影片票价" onBlur="check('input-price','schedule-price')">
                    </div>
                </div>
                <br><br>
